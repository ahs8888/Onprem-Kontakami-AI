<template>
    <AppLayout title="Add Prompt" :back="route('setup.agent-analysis.prompt.index')">
        <section class="mx-auto px-5 pb-5 md:max-w-[60%] md:px-0" x-data="{popup:false}">
            ...
            <ul class="flex flex-col gap-3">
                <li v-for="choice in choices" :key="choice.type">
                    ...
                    >
                        <div class="border-2 border-yellow rounded-full w-fit block">
                            <input
                                type="radio"
                                name="type"
            ...
            <div class="mt-3 flex justify-end">
                <ButtonYellow
                    :href="selectedType ? route('setup.agent-analysis.prompt.create', selectedType) : 'javascript:;'"
                    class="px-8"
                    :class="{
