<template>
    <AppLayout title="Add Prompt" :back="route('setup.recording-analysis.prompt.index')">
        <section class="mx-auto px-5 pb-5 md:max-w-[60%] md:px-0" x-data="{popup:false}">
            ...
            <ul class="flex flex-col gap-3">
                <li v-for="choice in choices" :key="choice.type">
                    ...
                    >
                        <div class="rounded-full border-2 border-yellow w-fit h-[19px]">
                            <input
                                type="radio"
                                name="type"
                                class="h-[15px] w-[15px] cursor-pointer !border-white shadow-none outline-none checked:!border-[3px] mt-[-11px]"
            ...
            <div class="mt-3 flex justify-end">
                <ButtonYellow
                    :href="selectedType ? route('setup.recording-analysis.prompt.create', selectedType) : 'javascript:;'"
                    class="px-8"
                    :class="{
