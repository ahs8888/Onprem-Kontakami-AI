...
import { routeAppendParam } from "./global-function";
...
export const usePaginate = ({
     ...
     const fetchData = (callbackFunction?: any) => {
          const queryParam = window.location.search
          let params: any = {}
          if (queryParam) {
               const objQueryParam = new URLSearchParams(queryParam);
     ...
     window.addEventListener("refreshDataTable", fetchData);
