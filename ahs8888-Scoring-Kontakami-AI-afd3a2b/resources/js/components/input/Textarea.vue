...
<template>
    <label
        :for="id"
        class="text-[12px] text-dark font-krub-medium mb-1 pre-text-content flex gap-1 items-center"
        v-bind:class="{
            'text-red': error,
        }"
        v-if="label"
    ...
    >
        ...
        <textarea
            ...
            "
            class="border rounded-lg placeholder:text-[#615e5e] px-4 text-[12px] outline-none shadow-none py-3 w-full disabled:bg-[#F3F3F3]"
            v-bind:class="{
                'border-red': error,
            }"
        >
